...
app.on('ready', () => {
    ...
    // 添加AI助手打开事件的处理
    ipcMain.on('open-ai-assistant', () => {
        if (_windows.main && _windows.main.webContents) {
            _windows.main.webContents.send('open-ai-assistant');
        }
    });
    ...
    ipcMain.on('open-settings', () => {
        if (_windows.main && _windows.main.webContents) {
            _windows.main.webContents.send('open-settings');
        }
    });
